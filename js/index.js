...
function dataRender(data) {
    ...
    if(data.name == '链接') {
        ...
        if(document.location.host.includes('gitee')) baseUrl = 'https://gitee.com/brenner8023/gdut-course/tree/master/public';
        ...
        data.children.forEach((item, idx) => {
            ...
            <tr>
                <td class="col-1">${svgStr}${idx}</td>
                <td class="col-2">
                <a href="${baseUrl}/${data.name}/${item}" target="_blank">
                    <p>${item}</p>
                </a>
                </td>
            </tr>
...
function main($) {
    ...
    $.data[6] = {
        ...
        children: [
            ...
            {
                url: '//weibo.com/gdutnc',
                name: '广东工业大学官方微博'
            },
            {
                url: '//www.zhihu.com/topic/19604314/hot',
                name: '工大知乎'
            },
            {
                url: 'http://www2.gdut.edu.cn/newgdut/dhdy/dhdxc1.htm',
                name: '广工大电话电邮'
            },
            {
            ...
            {
                url: 'http://ehall.gdut.edu.cn/',
                name: '广工校园网缴费'
            },
            {
                url: '//jxfw.gdut.edu.cn/',
                name: '广东工业大学教务系统'
            },
            {
    ...
    wechat_btn.addEventListener('click', (e)=>{
        e.stopPropagation();
        pop.hidden = false;

        document.onclick = () => {
            pop.hidden = true;
            if(pop.hidden == true) document.onclick = null;
        };
    });
}
main(new Function("return this")());